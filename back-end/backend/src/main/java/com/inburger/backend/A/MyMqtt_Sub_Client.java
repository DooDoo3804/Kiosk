package com.inburger.backend.A;
...
public class MyMqtt_Sub_Client implements MqttCallback{
     ...
     * **/
    public MyMqtt_Sub_Client(Consumer<HashMap<Object, Object>> fnc){
        this.FNC = fnc;
    }
     ...
     * */
    public MyMqtt_Sub_Client init(String userName, String password, String serverURI, String clientId){
